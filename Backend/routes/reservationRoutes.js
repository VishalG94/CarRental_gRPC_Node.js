...
const { GET_RESERVATIONS_ROUTE, GET_RESERVATIONBYID_ROUTE, POST_RESERVATION_ROUTE, DELETE_RESERVATION_ROUTE, UPDATE_RESERVATION_ROUTE } = require("../constants/iconstants");
