...
const { GET_LOCATIONS_ROUTE, GET_LOCATIONBYID_ROUTE, POST_LOCATION_ROUTE, DELETE_LOCATION_ROUTE, UPDATE_LOCATION_ROUTE, POST_ADDVEHICLETOLOCATION_ROUTE } = require("../constants/iconstants");
